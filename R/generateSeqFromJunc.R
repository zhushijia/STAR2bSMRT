#' generateSeqFromJunc
#'
#' generateSeqFromJunc generates the transcript sequence from junc list
#' 
#' @param genome 
#' @param isoform
#' @param exp
...
#' 
#' 
generateSeqFromJunc = function( genome , juncList , exp , chrom , s , e )
{
	
	dna = lapply( juncList , function(junc) {
