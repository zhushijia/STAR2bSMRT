...
thresDis=c(1:30)
adjustNCjunc=TRUE
folder="/hpc/users/zhus02/schzrnas/sjzhu/Project/NRXN/result/STAR2bSMRT/pipeline_adjustNCjunc/"
...
STAR2bSMRT( genomeDir , genomeFasta , LR , SR1 , SR2 , thresSR , thresDis , outputDir , adjustNCjunc , chrom , s , e , cores)
