module load bedtools/2.18.2
bed="/sc/orga/projects/schzrnas/sjzhu/Project/NRXN/data/ToolCompare/NRXN1_hg19_ExonAnnotations_shijia_forBedtoolsCallExonExpression.txt"
parent="/sc/orga/projects/schzrnas/sjzhu/Project/NRXN/result/STAR2bSMRT/pipelineNew_testParameters/"
cd ${parent}/641_GABA/LR
samtools view -bS Aligned.out.sam > Aligned.out.bam # transform .sam file into .bam file
coverageBed -abam Aligned.out.bam -b $bed > NRXN1.txt
