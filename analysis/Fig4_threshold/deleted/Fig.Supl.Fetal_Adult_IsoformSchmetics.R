...
sampleNames = c("Adult 1","Adult 2","Adult 3","Fetal 1","Fetal 2","Fetal 3") #
...
#{
	...
	Name = reorder( paste0('isoform',1:nrow(exps)) , rowSums(log10(exps+1)) )
	...
	#############  isoform schematics
	################################################################################
	pdf("fetal.adult.heatmap_translated_Exp_threshold7.pdf")
