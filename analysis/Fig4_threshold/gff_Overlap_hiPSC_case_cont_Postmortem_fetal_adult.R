...
parai = parai2
samples = c( paste0( c("2607","553","581","641","642"),"/",parai ), 
                paste0( c("fetal_23wks","fetal_3wks"),"/",parai ), 
             paste0(c("fetal","adult_dlPFC1_10","NRXN_adult_dlPFC1_12","adult_dlPFC1_13"),"/",parai) )
sampleName = c("cont1","cont2","del1","del2","cont3",'fetal23w1','fetal3w','fetal23w2','adult1','adult2','adult3')
...
hiPSC = unionGff(tGffs[[1]],tGffs[[2]])
hiPSC = unionGff(tGffs[[1]], unionGff(tGffs[[2]],tGffs[[5]]) )
fetal = unionGff(tGffs[[6]], unionGff(tGffs[[7]],tGffs[[8]]) )
adult = unionGff(tGffs[[9]], unionGff(tGffs[[10]],tGffs[[11]]) )
...
n1 = length(fetal)
n2 = length(adult)
binom.test( c1, n1, c2/n2 , "greater" )
...
pdf("PCA_new_fetal_adult_hiPSC_topN.pdf")
...
pdf("PCA_new_fetal_adult_hiPSC_thres.pdf")
for(thres in c(1:30) )
{
  cat(thres,'\n')
  fthres(thres)
