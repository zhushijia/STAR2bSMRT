...
drawSchematics = function( case_ind, cont_ind, fileName  )
{
  # parai=parameters[6] 
  ...
  Name = reorder( paste0('isoform',1:nrow(exps)) , rowSums(log10(exps[,c(cont_ind,cont_ind)]+1)) )
...
drawSchematics( case_ind = c(3,4) , cont_ind = c(6:9) , fileName="hiPSCcont.postmortemFetalAdult_orderedExp.pdf")
