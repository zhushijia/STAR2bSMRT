...
gff = list()
gff[[1]] = readGff( "/hpc/users/zhus02/schzrnas/sjzhu/Project/NRXN/result/STAR2bSMRT/581/Exp/isoform_ts0_td0.gff" , chrom='chr2' , s=50149082 , e=51255411 )
gff[[2]] = readGff( "/hpc/users/zhus02/schzrnas/sjzhu/Project/NRXN/result/STAR2bSMRT/641/Exp/isoform_ts0_td0.gff" , chrom='chr2' , s=50149082 , e=51255411 )
gff[[3]] = readGff( "/hpc/users/zhus02/schzrnas/sjzhu/Project/NRXN/result/STAR2bSMRT/2607/Exp/isoform_ts0_td0.gff" , chrom='chr2' , s=50149082 , e=51255411 )
gff[[4]] = readGff( "/hpc/users/zhus02/schzrnas/sjzhu/Project/NRXN/result/STAR2bSMRT/553/Exp/isoform_ts0_td0.gff" , chrom='chr2' , s=50149082 , e=51255411 )
...
exp[[1]][ !is.na(match(gff[[1]],gff[[3]])) ]
exp[[1]][ !is.na(match(gff[[1]],gff[[4]])) ]
exp[[2]][ !is.na(match(gff[[2]],gff[[3]])) ]
exp[[2]][ !is.na(match(gff[[2]],gff[[4]])) ]



setwd("/sc/orga/projects/schzrnas/sjzhu/Project/NRXN/result/STAR2bSMRT/result")
png('gff_overlap_0_0.png',res=300,h=4200,w=4000)
par(mfrow=c(4,4))
...
names(xx) = samples
venn.diagram(xx, filename ="vennDiagram_0_0.png", height = 1800, width = 1800, fill=1:4 , alpha=0.3 ,imagetype = "png")
